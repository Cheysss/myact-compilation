...
const myObj2 = {
    ...
    img3 : "project3.PNG",
    dis3 : "This is just a UI about POS System, that focuses on the 7 principles of design. UI design creates the appearance of an app or website’s user interface. Also, it includes the interactivity and connectivity between different elements of the UI. It’s important because it provides the user experience (UX) followed by UX design testing.",
    btn3 : "Learn More"
}
